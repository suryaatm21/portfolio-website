      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <Card className="soft-card">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  This will open your default email client with a prefilled message. Your email address will not be
                  stored or shared.
                </motion.p>
              </form>
            </CardContent>
        ...
        <FadeInUp delay={0.2}>
          <div className="space-y-6">
            ...
            <motion.div
              className="p-4 rounded-lg bg-brand-accent/5 border border-brand-accent/10"
