          ...
          return (
            <div key={item.id} className="relative flex items-start gap-6">
              ...
              <div className="relative z-10 flex-shrink-0">
                ...
                >
                  <div className="text-center">
                    <div className="text-xs font-medium leading-tight">{item.year}</div>
                    {isExpanded ? (
              ...
              <div className="flex-1 min-w-0">
                <div className="mb-2">
                  <h3 className="text-lg font-heading font-semibold text-brand-primary">{item.title}</h3>
                  <p className="text-sm text-brand-secondary font-medium">{item.year}</p>
                </div>
